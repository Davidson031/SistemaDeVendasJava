...
public class ClientesDAO {
    ...
    public Clientes consultaPorNome(String nome){
         ...
         try {
            ...
            ResultSet rs = stmt.executeQuery();
            Clientes obj = new Clientes(); //criando objeto cliente
            
            if(rs.next()){
                obj.setId(rs.getInt("id")); //pegando o que tiver na coluna ID do ResultSet e coloca dentro de obj
                obj.setNome(rs.getString("nome"));
                obj.setRg(rs.getString("rg"));
                obj.setCpf(rs.getString("cpf"));
                obj.setEmail(rs.getString("email"));
         ...
         return obj;
             ...
             JOptionPane.showMessageDialog(null, "CLIENTE NAO EXISTE: " + e);
             return null;
         }
